...
\begin{titlepage}
    ...
    \begin{tikzpicture}[overlay, remember picture]
        ...
        \node at ([xshift = .5\paperwidth, yshift = -.375\paperheight]current page.north west) {\Huge\bfseries \parbox[c]{10em}{\centering 高等实分析引论\\ \bigskip\sffamily\large Gerald B. Folland~~著\\ 小飞舞~~译}};
    \end{tikzpicture}
\end{titlepage}
\chapter*{前言}
